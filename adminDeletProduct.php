...
<div id="mySidenav"class="wrapper">
    <div class="sidebar">
        <ul>
			...
			<li><a class="active "  href="adminDeletProduct.php">Delet Product<span class="sr-only">(current)</span></a></li>
			<li>
...
<div class="container" style="margin-left: 15%;">
	<div class="col-lg-12"><br><br>
		<h1 class="text-warning text-center">DELETE PRODUCT</h1>
		<br>
		<table class="table table-striped table-hover table-bordered">
			...
			<?php
				...
				$con = mysqli_connect("localhost","root","","login1");
				 $q = "select  * from product_final  ORDER BY type ASC";
			...
			<tr class="text-center">
				...
				<td> <button class="btn btn-danger"  name="Reject" > <a href="not_approved_product.php?id=<?php echo $res['id'];?>" class="text-white"> Delete</a></button></td>
