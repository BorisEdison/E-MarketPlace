...
<div id="mySidenav"class="wrapper">
    <div class="sidebar">
        ...
        <ul>
			...
			<li>
				<a class="active dropdown-toggle" href="#" id="navbarDropdownMenuLink1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				Payment Detail
	...
	<div class="col-lg-12"><br><br>
		<h1 class="text-black text-center">ONLINE PAYMEMT DETAILS</h1>
		<br>
        <a href="download.php"   >
		...
		<table class="table table-striped table-hover table-bordered">
			...
			<?php
				...
				$con = mysqli_connect("localhost","root","","login1");
				 $q = "select  * from payment_success where payment_status!=''";
           ...
           <!-- <td> <?php echo $res['id'] ?> </td>-->
				...
				<td> <?php echo $res['final_price']; ?> </td>
				<td> <button class="btn-danger"  name="Reject" > <a href="#" class="text-white"> Reject</a></button></td>
			</tr>
				<?php 
                }
			?>
