...
<div>
  ...
  <?php
    $con = mysqli_connect("localhost","root","","login1");
    $query = mysqli_query($con, "SELECT * FROM `product` WHERE `name` LIKE '%$keyword%' AND progress=2 ORDER BY `name`");
    ...
    <div class=" col-lg-3 col-md-6 col-sm-7"> 
          <div class="card text-center">
            <div class="card-block">
              ...
              <a href="Product_view_grains.php"  class="button btn btn-success"  style="margin-top: 10px;">See more</a>
            </div>
          </div>
    </div>
     ...
     <div class="col-lg-3 col-md-6 col-sm-7"> 
          <div class="card text-center">
            <div class="card-block">
              ...
              <a href="Product_view_vegetable.php" class="button btn btn-success" style="margin-top: 10px;">See more</a>
            </div>
          </div>
    </div>
     ...
     <div class="col-lg-3 col-md-6 col-sm-7"> 
          <div class="card text-center">
            <div class="card-block">
              ...
              <a href="Product_view_fruit.php" class="button btn btn-success" style="margin-top: 10px;">See more</a>
            </div>
          </div>
    </div>
     ...
     <div class="col-lg-3 col-md-6 col-sm-7"> 
          <div class="card text-center">
            <div class="card-block">
              ...
              <a href="Product_view_flower.php" class="button btn btn-success" style="margin-top: 10px;">See more</a>
            </div>
          </div>
    </div>
  </div>
