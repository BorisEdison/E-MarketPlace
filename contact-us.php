  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link active" href="comntact-us.php" >Contact-us</a>
      </li>
      <li class="nav-item">
...
<br><br>    <section classe ="contact py-5">
      <form action="contact.php" method="POST">
      <div class="container">
       <div class="row">
        <div class="col-1g-7 mx-auto">
          <div class="card" style="width: 700px; margin-top: 50px">
            <div class="card-body">
              <div class="row pb-3">
                <div class="col-lg-12">
           ...
           <div class="col-lg-6">
              ...
              <div class="row">
                <div class="col-lg-10">
                  ...
                  <input type="Phone" class="super"id="phno" name="phno" placeholder="Enter Phone Number"limit="10">
                   <span class="focus-border"></span>
            </div>
          </div>
               <div class="row pt-8">
            ...
            <div class="row pt-3">
              <div class="offset-2 col-leg-4">
                <input type="button" name="sumbit" class="btn btn-primary " style="margin-left: 120px;" value="Send Message"> 
