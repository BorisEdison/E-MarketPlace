...
<div id="mySidenav" class="wrapper">
    ...
    <div class="sidebar">
        ...
        <ul>
			<li><a class="active"  href="Admin_index.php">Reqest list<span class="sr-only">(current)</span></a></li>
  			<li><a class="dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				Manage User
    			</a>
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          			<a class="dropdown-item" href="adminMangeUser.php">Mange User</a>
		...
		<table class="table table-striped table-hover table-bordered">
			...
			<?php
				...
				$con = mysqli_connect("localhost","root","","login1");
				 $q = "select  * from product WHERE progress='1' ORDER BY type ASC";
			...
			<tr class="text-center">
				...
				<td> <button class=" btn btn-danger"  name="Reject" > <a href="not_approved_product.php?id=<?php echo $res['id'];?>" class="text-white"> Reject</a></button></td>
				<td> <button class=" btn btn-primary" name="Accept"> <a href="approved_product.php?id=<?php echo $res['id'];?>" class="text-white"> Accept</a> </button></td>
			</tr>
