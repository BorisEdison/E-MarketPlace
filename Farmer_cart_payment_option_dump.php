...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" type="text/css" href="pbuy.css"> 
  <script type="text/javascript">
    ...
    function b1()
    {
      ...
      if (rd1.checked==true){
            document.getElementById("ok").action="cashondilivery.php";
          }      else if(rd2.checked==true){
       document.getElementById("ok").action="cart_instamojo.php?final_price=<?php echo $final_price?>";
}      
    ...
    <section classe ="contact py-5">
      ...
      <div class="container">
       ...
       <header class="head"><b>Payment Method</b></header>
           ...
           <button onclick="b1()" type="submit" class="btn2" >Continue</button><br>
