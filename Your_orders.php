    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" >
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link active" href="Your_orders.php"><i class="fa fa-eye" aria-hidden="true"></i>View Order</a>
        </li>
...
$final_price=0;
  ...
  <div class="row g-0  ">
   ...
   <button class=" btn btn-primary " style="border-radius: 10px; margin-left: 250px;"> <a href="recipt.php?id=<?php echo $res['id'];?>"class="text-white"> GET INVOICE </a> </button>
