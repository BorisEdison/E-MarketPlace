<?php 
	...
	{	 $fname =$_POST['firstname'];
		...
		if($pass==$pass1)
		{
			$sql="INSERT INTO `flogin`( `fname`, `LNAME`, `MNO`, `STATE`, `birthhd`, `mail`, `pass`) VALUES ('$fname',' $lname','$no','$state','$db','$mail','$pass')";
			$select = mysqli_query($con, "SELECT `mail` FROM `flogin` WHERE `mail` = '$mail'");
