...
<?php 
 ...
 ?>
   ...
   <form method="post" id="ok" name="ok" action="Payment_details_update.php?Paymentid=<?php echo $Paymentid;?>&&payment_status=<?php echo $payment_status;?>&&payment_request=<?php echo $Payment_request_id;?>" >
      <div class="container">
       <div class="row">
