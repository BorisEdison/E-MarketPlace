...
<body>
      ...
      $id=$_GET['id']; 
      ?>
     <form action="Farmer_buy_address_connection.php?id=<?php echo$id;?>" method="POST">
      <div class="container">
       <div class="row">
        <div class="car">
              ...
              <input type="text" class="super" class="" id="lastname" name="lastname" placeholder="Enter Last Name" required="">
                ...
                <div class="col-lg-13">
                  <label class="fa fa-home"><b>House No.,Building Name*</b></label>
                      <input type="text" class="super" id="houseno" name="houseno" placeholder="Enter House No.,Building Name" required="">

                </div>
                <div class="col-lg-13">
                    <label class=""><b>Road Name,Area,Colony*</b></label><br>
                    <input type="text" class="super" id="area" name="area" placeholder="Enter RoadName,Area,Colony" required="">
                  </div>
