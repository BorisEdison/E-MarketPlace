	...
	?>
			<tr class="text-center">
				...
				<td id="price"name="price"> <?php echo $res['price']; ?> </td>
				 ...
				 <td> <input type="number"  id="quantity"name="quantity" min="0" max="50" value="<?php echo $res['p_quantity']; ?>" onchange="totalvalue();updateQ(this.value,<?php echo $res['id']; ?>,<?php echo $res['quantity'] ?>);"/>
          <h4 style="opacity: 0;" id="msg" class="text-danger"> <i>out of stock </i></h4>
         </td>
				<td> <input type="text" name="subtotal" readonly="true" ></td>
				<td> <button class=" btn btn-danger " style="border-radius: 10px;"> <a href="F_Remove.php?id=<?php echo $res['id'];?>" class="text-white"> Remove</a> </button></td>
...
<div class="totalamt">
   <button class=" btn btn-warning " id="buy"style="border-radius: 10px; float: right; margin-right: 150px;"> 
    <a href="Farmer_address1.php" class="text-white" id="link">Place order</a> </button>
