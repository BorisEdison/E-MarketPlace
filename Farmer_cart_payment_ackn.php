...
<?php 
 ...
 $Payment_request_id=$_GET['payment_request_id'];
  ...
  $con = mysqli_connect("localhost","root","","login1"); 
	 $query="select * from add_cart where progress=2 and username='$adminlogin'";
 ...
 ?>
   ...
   <form method="post" id="ok" name="ok" action="Farmer_cart_Payment_details_update.php?Paymentid=<?php echo $Paymentid;?>&&payment_status=<?php echo $payment_status;?>&&payment_request=<?php echo $Payment_request_id;?>" >
      <div class="container">
       <div class="row">
