<?php 
 ...
 $q="SELECT username FROM address";
 $qu=mysqli_query($con,$q);
$res=mysqli_fetch_array($qu);
$username=$res['username'];
if ($username==$adminlogin) {
$up="UPDATE `address` SET `firstname`='$firstname',`lastname`='$lname',`phno`='$phno',`houseno`='$houseno',`area`='$area',`pincode`='$pincode',`state`='$state',`city`='$city' WHERE username='$adminlogin'";
