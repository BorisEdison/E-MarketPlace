...
foreach($heading as $column_heading){
    if($column_heading!='payment_id'and$column_heading!='payment_status' and$column_heading!='payment_request_id'){
        $pdf->CellFitScale(35,15,join(" ",(explode("_",$column_heading))),1,'R');
    }

}
}}
//code for print data
$sql = "SELECT `id`,`name`, `p_quantity`, `username`, `final_price` FROM `payment_success` WHERE payment_status='Credit'";
