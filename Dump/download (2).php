...
foreach($heading as $column_heading){
    if($column_heading!="payment_id"and$column_heading!="payment_sttatus"and$column_heading!="payment_request_id"){
        $pdf->CellFitScale(24,15,join(" ",(explode("_",$column_heading))),1);
    }
}

}}
//code for print data
$sql = "SELECT * from  payment_success";
