  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" >
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="Mycart.php"><i class="fa fa-cart-plus" aria-hidden="true"></i> Cart</a>
        </li>
        <li class="nav-item">
...
<div class="totalamt">
   <button class=" btn btn-warning " id="buy"style="border-radius: 10px; float: right; margin-right: 150px;" > <a href="address1.php" class="text-white" id="link" >Place order</a> </button>
