...
<div class="container">
  ...
  $sql ="SELECT id,name,image,price,quantity FROM product_final where type='fruit'ORDER BY id ASC";
			...
			<div class="col-lg-3 col-md-6 colsm-12">
				<form>
					<div class="card">
						...
						<div class="card-body"><a href="user_dynamic1_product.php?id=<?php echo $res['id'];?>" >
							<img src=" <?php echo $res['image'];  ?>" alt="farmer" class="img-fluid mb-2" style="height: 200px; width:300px;" ></a><br>
