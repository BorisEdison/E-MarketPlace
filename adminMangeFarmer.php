...
<div class="container" style="margin-left: 15%;">
	<div class="col-lg-12"><br><br>
		<h1 class="text-warning text-center">Mange Farmer</h1>
		<br>
		<table class="table table-striped table-hover table-bordered">
			...
			<tr class="text-center">
				...
				<td> <button class="btn btn-danger"  name="Reject" > <a href="delete_User.php?id=<?php echo $res['id'];?>&name=flogin" class="text-white"> Delete</a></button></td>
			</tr>
			<?php 
                }
			?>
